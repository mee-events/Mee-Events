...
| Real SMS sandbox/production operations                                             | `ExotelOtpProvider` (ADR 0012; offline adapter only)  | Real credentials, SMS delivery, DLT evidence, callbacks, and monitoring remain INT-01                                                  |
