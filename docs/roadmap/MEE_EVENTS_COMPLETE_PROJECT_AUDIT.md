...
- Flutter format check — **PASS**, 199 files unchanged.
...
| ------------------------ | ---------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| Backend unit/foundation  | 173 tests PASS                                 | Many use fake repositories; add live DB/HTTP/authorization concurrency tests                    |
