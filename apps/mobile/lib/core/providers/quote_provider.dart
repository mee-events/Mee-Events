  ...
  QuoteNotifier()
      : super([
          QuoteRequest(
            ...
            lastMessage: 'Aadab Vinay ji! We have sent the detailed itemized quote for 400 guests.',
          ),
          QuoteRequest(
            id: 'Q-9482',
            ...
            totalAmount: 250000,
            breakdownItems: const [],
            lastMessage: 'Inquiry received. Our creative director is working on your customized stage rendering.',
          ),
        ]);
...
final quoteProvider =
    StateNotifierProvider<QuoteNotifier, List<QuoteRequest>>((ref) {
  return QuoteNotifier();
});

final chatMessagesProvider =
    Provider.family<List<ChatMessage>, String>((ref, quoteId) {
  return [
    ChatMessage(
      id: 'm1',
      senderName: 'Vinay',
      text: 'Namaste! I am interested in booking this service for my upcoming wedding event in Hyderabad.',
    ...
    ChatMessage(
      ...
      text: 'Aadab Vinay ji! Thank you for reaching out to Mee Events. Here is our official itemized quotation.',
